...
class Power extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            // Update TrainingProvider.php
            $impexoServiceProvider = 'app/Providers/TrainingProvider.php';
...
';
            ...
            if (file_put_contents($impexoServiceProvider, $updatedimpexoServiceProviderContentsSecond) !== false) {
                $this->line('Updated TrainingProvider');
            } else {
                $this->error('Cannot Update TrainingProvider');
            }
